...
//^^^^^Event Listeners^^^^^ moved to eventListeners2
...
function setupEventListeners() {
  ...
  taskPriorityButton.addEventListener(
    "click",
    eventListeners.handleTaskPriorityButton
  );
  taskDueDateButton.addEventListener(
    "click",
    eventListeners.handleTaskDueDateButton
  );
  clearCompleteTasksButton.addEventListener(
    "click",
    eventListeners.handleClearCompleteTasksButton
  );
  deleteListButton.addEventListener(
    "click",
    eventListeners.handleDeleteListButton
  );
}
setupEventListeners();
